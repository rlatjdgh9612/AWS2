...
public class TestPointer : MonoBehaviour
{
    ...
    [SerializeField] private SteamVR_Action_Boolean RightTrigger;
    public GameObject testPointerCube;
    public Camera Camera { get; private set; } = null;

    private LineRenderer lineRenderer = null;
    public VRInputModule_Test inputModule;
    ...
    private void Update()
    {
        if (RightTrigger.GetState(SteamVR_Input_Sources.RightHand)) UpdateLine();
        if (RightTrigger.GetStateUp(SteamVR_Input_Sources.RightHand))
        {
            lineRenderer.enabled = false;
        }
    }
    ...
    private void UpdateLine()
    {
        ...
        testPointerCube.transform.position = data.pointerCurrentRaycast.worldPosition;
